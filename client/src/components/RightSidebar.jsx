    ...
    selectedUser && (
      <div className={`bg-[#818582]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}>
        ...
        <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
          ...
          <p className='text-center text-white text-sm leading-tight max-w-[200px] break-words px-4'>
            {selectedUser.bio}
          </p>
        </div>
        ...
        <div className="px-4 text-white text-sm font-medium mt-4 w-full">
          <p className="mb-2">Media</p>
          
          <div className='max-h-[180px] overflow-y-scroll grid grid-cols-2 gap-2 pr-1'>
